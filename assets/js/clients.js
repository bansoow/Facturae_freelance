...
function addClient(){
  ...
  erreurNom.innerHTML = "<span>veuillez indiquer votre nom d'entreprise</span>";
  }
  if (newClientAddress1 == "") {
  var erreurClientSiren = document.getElementById("erreurClientSiren");
  erreurClientSiren.innerHTML = "<span>veuillez indiquer le numéro de SIREN</span>";
  }
  if (newClientAddress2 == "") {
  var erreurClientAdresse = document.getElementById("erreurClientAdresse");
  erreurClientAdresse.innerHTML = "<span>veuillez indiquer l'adresse du client</span>";
  }
  if (newClientSIREN == "") {
  var erreurCP = document.getElementById("erreurCP");
  erreurCP.innerHTML = "<span>veuillez indiquer son code postal et sa ville</span>";
  }else {
